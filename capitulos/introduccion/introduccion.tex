...
Una de las actividad mas populares en la \webINT es comprar. La razón es por que tiene un encanto especial -puedes comprar en tiempo libre, cualquier momento, incluso usando pijamas. Literalmente cualquiera puede tener páginas para mostrar sus productos y servicios.
...
\begin{itemize}
	\item \textbf{\shoppingCart}: \ecommerce software en un servidor \webINT que permite a los visitantes del \websiteINT seleccionar \itemsCommerce para eventualmente comprarlos.
...
Después de años en avances en computación personal, tecnologías creativas han impulsado la \webINT a sus limites, y los \webINT \browsers han evolucionado para mantenerse al día.
...
Se propone desarrollar un \frameworkPC utilizando tecnología \webINT la cual ha madurado a una plataforma con aplicaciones \fullFeatured, \javaScriptNAME \runtime rápidos y \standard \htmlfive permitiendo crear aplicaciones enriquecidas que antes fueron solo posibles en plataformas nativas.
