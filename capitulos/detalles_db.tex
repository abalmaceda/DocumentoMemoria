...
\medskip
\begin{lstlisting}[caption= Información extra \itemCOM, label=source:javascript:info_extra_itemcommerce]
"metafields" : [ 
        {
            "key" : "Material",
            "value" : "Cotton"
...
\medskip
\begin{lstlisting}[caption= \updates en un \itemCOM, label=source:javascript:updates_itemcommerce]
"variants" : [ 
        {
