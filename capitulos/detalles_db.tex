...
\medskip
\begin{lstlisting}[caption= Información extra de un producto, label=source:javascript:info_extra_itemcommerce]
"metafields" : [ 
        {
            "key" : "Material",
            "value" : "Cotton"
...
\medskip
\begin{lstlisting}[caption= Actualizaciones en un producto, label=source:javascript:updates_itemcommerce]
"variants" : [ 
        {
