...
No importa lo bueno que una aplicación sea, la cantidad de prestaciones, en fin....  Incluso puede ser superior a las que los competidores presentan; todo esto significa nada si finalmente la aplicación no es utilizada por los usuarios objetivos. \googleNAME es completamente consiente de esta situación en donde por ejemplo tenemos 
...
\input{capitulos/requerimientos/table_ranking_frameworks_meteor.tex}
