...
Una comunidad es uno de los factores mas importantes para considerar cuando se elije un \frameworkPC. Una extensa comunidad significa mas preguntas contestadas, mas módulos \thirdParty, más tutoriales en \youtubeNAME, etc. \angularjsNAME es sin dudas la plataforma con mas apoyo como se puede observar en \reftabla{tab:framework_community}.
