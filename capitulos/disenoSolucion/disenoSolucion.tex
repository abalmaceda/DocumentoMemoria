...
Una aplicación \webINT es aquella que corre sobre un \webINT \browser, el cual obtiene los datos que procesa a través de un protocolo estándar de comunicación llamado \httpNAME que opera en la \applayer, la cual es parte de \osimodel.
