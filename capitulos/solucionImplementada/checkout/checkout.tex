...
\section{\checkoutEF}\label{chapter:solucionimplementada:section:checkout}
	...
	\input{capitulos/solucionImplementada/checkout/account/account.tex}

	% Paso selección shipping & billing address
	\input{capitulos/solucionImplementada/checkout/address/address.tex}

	% Paso opciones de envío
	\input{capitulos/solucionImplementada/checkout/shipping/shipping.tex}

	% Paso resumen de la compra
	\input{capitulos/solucionImplementada/checkout/review/review.tex}

	% Paso add paymant to complete order
	\input{capitulos/solucionImplementada/checkout/payment/payment.tex}