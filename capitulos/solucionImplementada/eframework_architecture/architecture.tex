...
\section{Arquitectura del \frameworkPC}\label{cap:arquitectura:section:arquitectura_framework}
	...
	\subsection{\packagesAS}
		...
		\input{capitulos/solucionImplementada/eframework_architecture/architecture/package_structure.tex}
		...
		% Sección que habla sobre los workflows en el framwork
		\input{capitulos/solucionImplementada/eframework_architecture/architecture/workflow_framework.tex}