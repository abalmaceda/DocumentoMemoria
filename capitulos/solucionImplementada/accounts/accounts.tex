...
La creación de una cuenta se ha pensado realizando la menor cantidad de acciones posibles (ver \refFigura{figure:account:create_account:form}). Agregar acciones innecesarias puede significar que los usuarios desistan y dejen el sitio\cite{online_goodgui_org}.
