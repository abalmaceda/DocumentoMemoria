...
\begin{itemize}
	...
	\item \textbf{\apache} \http \server, coloquialmente llamado \apache, es el \software del \server \web mas utilizado en el mundo \cite{online_technology_apache}.
