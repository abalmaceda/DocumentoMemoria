...
\subsubsection{\isomorphicJSFwASref}
	...
	\input{capitulos/estadoarte/table_resume_full_stack_javaScript.tex}
...
\input{capitulos/estadoarte/client_side_mvc_diagram.tex}
...
Algunas de las aplicaciones y \viewLogicAS que son utilizadas recurrentemente, pueden ser ejecutadas tanto en el \serverAS como en \clientAS. Esto permite nuevas posibilidades - \performanceQA \optimizationQA, mejor \maintainabilityQA, \seoINT por \defaultCPT, y más \statefulINT aplicaciones \webINT.
...
Con la aparición de \nodejsNAME, un \fastQA, \stableQA \serverSideAS \javaScriptNAME \runtimeCPT, es factible hacer este sueño realidad. Creado las abstracciones apropiadas, es posible escribir \logicAS de aplicación que \runCPT en el \serverAS y el \clientAS - justamente la definición de \isomorphicAS \javaScriptNAME.
...
\label{cap:estadoArte:subsection:isomorphic_javaScript_framework}
...
El \clientAS y el \serverAS son \environmentsPL muy distintos, y por lo tanto es necesario un conjunto de abstracciones que 
