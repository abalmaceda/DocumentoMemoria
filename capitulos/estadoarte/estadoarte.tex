...
\begin{itemize}
	\item \textbf{\mongodbNAME} (de "hu\textbf{mongo}us") es un base de datos \documentOriented \openSource, y la base de datos líder \nosql. Escrita en \cPlusPlus \cite{technology_mongodb}.
