...
El atributo \textit{'variants'} corresponde a un \arrayPL que contiene cada una de las modificaciones que el producto tiene durante su vida. Como ejemplo en \refsource{source:javascript:data_model_item_variant} se observa que el atributo \textit{'inventoryQuantity'} disminuye de 49 a 45 productos.
