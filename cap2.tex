...
La principal idea de Node.js : usar \textit{non-blocking}, \textit{event-driven I/O} para permanecer liviano y eficiente para enfrentar aplicaciones \textit{data-intensive} \textit{real-time} que corren a traves de dispositivos distribuidos.
...
\begin{itemize}
	...
	\item Permite velocidad de desarrollo y ejecución. En otras palabras iteraciones rapidas.
